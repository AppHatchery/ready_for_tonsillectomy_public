...
import '../widgets/hospital_gown_widget_spanish.dart';
import '../widgets/hospital_next_button_widget_b_spanish.dart';
import 'package:pendo_sdk/pendo_sdk.dart';

class GettingReadyPageCSpanish extends StatefulWidget {
  const GettingReadyPageCSpanish({Key? key}) : super(key: key);

  @override
  State<GettingReadyPageCSpanish> createState() =>
      _GettingReadyPageStateCSpanish();
}

class _GettingReadyPageStateCSpanish extends State<GettingReadyPageCSpanish>
  ...
  Widget build(BuildContext context) {
    _size = MediaQuery.of(context).size;
    return Scaffold(
      backgroundColor: HexColor("#ecf7f4"),
      ...
      body: Align(
        ...
        child: SingleChildScrollView(
          child: Stack(children: [
            Padding(
              padding: EdgeInsets.only(top: 1.35 * screenWidth),
              child: Stack(alignment: Alignment.bottomRight, children: [
                Container(
                    width: screenWidth,
                    height: 0.4 * screenWidth,
                    color: HexColor("#e5e6e7")),
                HospitalNextButton2Spanish(
              ...
              Column(children: [
                Padding(
                  padding: EdgeInsets.only(
                      top: 0.04 * screenWidth, bottom: 0.0533 * screenWidth),
                  child: RichText(
                    textAlign: TextAlign.center,
                    text: TextSpan(
                        text:
                            "Después, te pones un pijama especial para la \ncirugía. Se llama ",
                        style: TextStyle(
                            letterSpacing: 0,
                            height: 1.2,
                            fontFamily: "proxima",
                        ...
                        children: const <TextSpan>[
                          ...
                          TextSpan(
                              text:
                                  ". También \nte van a poner un brazalete con tu nombre. ")
                        ]),
                  ),
                ),
                Container(
                    width: screenWidth,
                    height: 0.0267 * screenWidth,
                    color: HexColor("#e5e6e7")),
                Padding(
                        ...
                        children: const <TextSpan>[
                          TextSpan(
                              ...
                              style: TextStyle(
                                  ...
                                  height: 1.2,
                                  fontWeight: FontWeight.bold)),
                          TextSpan(text: " la cortina!")
                        ]),
                  ),
                ),
              ]),
              Padding(
                  padding: EdgeInsets.only(top: 0.28 * screenWidth),
                  child: const HospitalGownSMSpanish()),
            ]),
          ]),
        ),
      ),
  ...
  void submitSeconds(String state) {
    stopTimer();
    PendoFlutterPlugin.track('Getting_ready_c_spanish',
