...
class NotificationPageWeekAfter extends StatefulWidget {
  const NotificationPageWeekAfter({Key? key}) : super(key: key);

  @override
  State<NotificationPageWeekAfter> createState() =>
      _NotificationPageWeekAfterState();
}

class _NotificationPageWeekAfterState extends State<NotificationPageWeekAfter>
        ...
        child: SingleChildScrollView(
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Padding(
              ...
              child: Text(
                "Some kids feel discomfort in their ears or neck after throat surgery. "
                "The same big nerve tells your brain about what is happening in the ears, the back of the mouth, and the neck, so pain in any of these areas is usually related to surgery. "
                "\n\nMedicine, heat, or massage may help.",
                style: TextStyle(
                    letterSpacing: 0,
                    height: 1.2,
                    fontFamily: "proxima",
  ...
  void submitSeconds(String state) {
    stopTimer();
    PendoFlutterPlugin.track('NotificationPageWeekAfter',
