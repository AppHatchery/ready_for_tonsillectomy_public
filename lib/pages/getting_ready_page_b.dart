...
import '../widgets/hospital_text_widget.dart';
import '../widgets/hospital_next_button_widget_a.dart';
import 'package:pendo_sdk/pendo_sdk.dart';

class GettingReadyPageB extends StatefulWidget {
  const GettingReadyPageB({Key? key}) : super(key: key);

  @override
  State<GettingReadyPageB> createState() => _GettingReadyPageStateB();
}

class _GettingReadyPageStateB extends State<GettingReadyPageB>
  ...
  void submitSeconds(String state) {
    ...
    PendoFlutterPlugin.track(
        'Getting_ready_b', {'time_on_page': secondsSpent, 'status': state});
  }
}
