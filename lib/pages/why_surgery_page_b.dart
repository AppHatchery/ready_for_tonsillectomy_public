...
import '../widgets/big_tonsils_widget.dart';
import '../widgets/apnea_widget.dart';
import 'package:pendo_sdk/pendo_sdk.dart';

class WhySurgeryPageB extends StatefulWidget {
  const WhySurgeryPageB({Key? key}) : super(key: key);

  @override
  State<WhySurgeryPageB> createState() => _WhySurgeryPageStateB();
}

class _WhySurgeryPageStateB extends State<WhySurgeryPageB>
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          Align(
            ...
            child: Padding(
              ...
              child: Text(
                  "Some kids have extra-big tonsils. \nInstead of hiding on each side of your throat, \nthey might almost touch in the middle!",
          ...
          const BigTonsilsAnimation(),
          Padding(
              padding: EdgeInsets.only(
                  top: 0.0267 * screenWidth, bottom: 0.0533 * screenWidth),
              child: const ApneaSlider()),
          Padding(
  ...
  void submitSeconds(String state) {
    ...
    PendoFlutterPlugin.track(
        'Why_surgery_b', {'time_on_page': secondsSpent, 'status': state});
  }
}
