...
import '../widgets/sick_tonsils_widget.dart';
import '../widgets/tonsillitis_widget.dart';
import 'package:pendo_sdk/pendo_sdk.dart';

class WhySurgeryPageC extends StatefulWidget {
  const WhySurgeryPageC({Key? key}) : super(key: key);

  @override
  State<WhySurgeryPageC> createState() => _WhySurgeryPageStateC();
}

class _WhySurgeryPageStateC extends State<WhySurgeryPageC>
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          Align(
            ...
            child: Padding(
              ...
              child: Text(
                  "Tonsils can get sick from bad germs. \nSick tonsils are swollen (big) and red. \nThey have white or yellow spots.",
          ...
          const SickTonsilsAnimation(),
          Padding(
              padding: EdgeInsets.only(
                  top: 0.0267 * screenWidth, bottom: 0.0533 * screenWidth),
              child: const TonsillitisSlider()),
          Padding(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                submitSeconds("Finished");
                Navigator.pushNamed(context, '/why_surgery_d');
              },
              child: Padding(
  ...
  void submitSeconds(String state) {
    ...
    PendoFlutterPlugin.track(
        'Why_surgery_c', {'time_on_page': secondsSpent, 'status': state});
  }
}
