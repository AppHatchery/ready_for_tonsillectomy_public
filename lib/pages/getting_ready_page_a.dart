...
import '../widgets/breakfast_portal_button_widget.dart';
import '../widgets/worried_portal_button_widget.dart';
import '../widgets/hospital_button_widget.dart';
import 'package:pendo_sdk/pendo_sdk.dart';

class GettingReadyPageA extends StatefulWidget {
  const GettingReadyPageA({Key? key}) : super(key: key);

  @override
  State<GettingReadyPageA> createState() => _GettingReadyPageStateA();
}

class _GettingReadyPageStateA extends State<GettingReadyPageA>
            ...
            child: Align(
              ...
              child: Column(children: [
                Padding(
                  ...
                  child: Text("Here are some good things to know.",
                ...
                GestureDetector(
                    child: const HospitalButton(),
                    onTap: () {
                      submitSeconds("Finished");
                      Navigator.pushNamed(context, '/getting_ready_b');
                    }),
              ]),
            ),
          ),
  ...
  void submitSeconds(String state) {
    ...
    PendoFlutterPlugin.track(
        'Getting_ready_a', {'time_on_page': secondsSpent, 'status': state});
  }
}
