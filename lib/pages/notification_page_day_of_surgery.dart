...
class NotificationPageDOS extends StatefulWidget {
  const NotificationPageDOS({Key? key}) : super(key: key);

  @override
  State<NotificationPageDOS> createState() => _NotificationPageDOSState();
}

class _NotificationPageDOSState extends State<NotificationPageDOS>
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Padding(
              ...
              child: RichText(
                text: TextSpan(
                    text:
                        "The big day is here! Going into surgery with an empty stomach makes your child’s surgery safe, so ",
                    style: TextStyle(
                        letterSpacing: 0,
                        height: 1.2,
                        fontFamily: "proxima",
                    ...
                    children: const <TextSpan>[
                      TextSpan(
                          text: "no breakfast this morning",
                          style: TextStyle(
                              letterSpacing: 0,
                              height: 1.2,
                      ...
                      TextSpan(
                          text:
                              ". \n\nMost kids can have clear drinks like water, apple juice, or sports drinks before surgery, but "),
                      TextSpan(
                          ...
                          style: TextStyle(
                              ...
                              height: 1.2,
                              fontWeight: FontWeight.bold)),
                      TextSpan(text: " about when to stop drinking."),
                    ]),
              ),
            ),
            SizedBox(
  ...
  void submitSeconds(String state) {
    ...
    PendoFlutterPlugin.track(
        'NotificationPageDOS', {'time_on_page': secondsSpent, 'status': state});
  }
}
