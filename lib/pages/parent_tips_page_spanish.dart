...
import '../widgets/parent_tip_boxes_widget_spanish.dart';
import 'package:pendo_sdk/pendo_sdk.dart';

class ParentTipsPageSpanish extends StatefulWidget {
  const ParentTipsPageSpanish({Key? key}) : super(key: key);

  @override
  State<ParentTipsPageSpanish> createState() => _ParentTipsPageSpanishState();
}

class _ParentTipsPageSpanishState extends State<ParentTipsPageSpanish>
  ...
  void submitSeconds(String state) {
    stopTimer();
    PendoFlutterPlugin.track('Parents_tips_spanish',
