...
import '../widgets/sick_tonsils_widget_spanish.dart';
import '../widgets/tonsillitis_widget_spanish.dart';
import 'package:pendo_sdk/pendo_sdk.dart';

class WhySurgeryPageCSpanish extends StatefulWidget {
  const WhySurgeryPageCSpanish({Key? key}) : super(key: key);

  @override
  State<WhySurgeryPageCSpanish> createState() => _WhySurgeryPageStateCSpanish();
}

class _WhySurgeryPageStateCSpanish extends State<WhySurgeryPageCSpanish>
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          Align(
            ...
            child: Padding(
              ...
              child: Text(
                  "Los gérmenes malos pueden enfermar las \namígdalas. Se ponen rojas e hinchadas (grandes). \nLes salen manchas blancas o amarillas.",
          ...
          const SickTonsilsAnimationSpanish(),
          Padding(
              padding: EdgeInsets.only(
                  top: 0.0267 * screenWidth, bottom: 0.0533 * screenWidth),
              child: const TonsillitisSliderSpanish()),
          Padding(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                submitSeconds("Finished");
                Navigator.pushNamed(context, '/why_surgery_d_spanish');
              },
              child: Padding(
  ...
  void submitSeconds(String state) {
    stopTimer();
    PendoFlutterPlugin.track('Why_surgery_c_spanish',
