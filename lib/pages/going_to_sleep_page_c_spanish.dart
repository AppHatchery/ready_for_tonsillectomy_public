...
import '../widgets/anesthesia_thought_carousel_widget_spanish.dart';
import 'package:pendo_sdk/pendo_sdk.dart';

class GoingToSleepPageCSpanish extends StatefulWidget {
  const GoingToSleepPageCSpanish({Key? key}) : super(key: key);

  @override
  State<GoingToSleepPageCSpanish> createState() =>
      _GoingToSleepPageStateCSpanish();
}

class _GoingToSleepPageStateCSpanish extends State<GoingToSleepPageCSpanish>
        ...
        child: SingleChildScrollView(
          child: Center(
            child: Column(
                ...
                children: [
                  const ManuallyControlledSliderThoughtsSpanish(),
                  Padding(
                          ...
                          Padding(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () {
                                submitSeconds("Finished");
                                Navigator.pushNamed(
                                    context, '/operating_room_spanish');
                              },
                              child: Padding(
                                  padding: EdgeInsets.only(
  ...
  void submitSeconds(String state) {
    stopTimer();
    PendoFlutterPlugin.track('Going_to_sleep_c_spanish',
