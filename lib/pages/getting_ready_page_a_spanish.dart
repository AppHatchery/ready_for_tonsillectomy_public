...
import '../widgets/breakfast_portal_button_widget_spanish.dart';
import '../widgets/worried_portal_button_widget_spanish.dart';
import '../widgets/hospital_button_widget_spanish.dart';
import 'package:pendo_sdk/pendo_sdk.dart';

class GettingReadyPageASpanish extends StatefulWidget {
  const GettingReadyPageASpanish({Key? key}) : super(key: key);

  @override
  State<GettingReadyPageASpanish> createState() =>
      _GettingReadyPageStateASpanish();
}

class _GettingReadyPageStateASpanish extends State<GettingReadyPageASpanish>
              ...
              child: Column(children: [
                Padding(
                  padding: EdgeInsets.only(
                      top: 0.05 * screenWidth, bottom: 0.05 * screenWidth),
                  child: Text("Información que debes saber.",
                ...
                const BreakfastOverlaySpanish(),
                const WorriedOverlaySpanish(),
                GestureDetector(
                    child: const HospitalButtonSpanish(),
                    onTap: () {
                      submitSeconds("Finished");
                      Navigator.pushNamed(context, '/getting_ready_b_spanish');
                    }),
              ]),
            ),
          ),
  ...
  void submitSeconds(String state) {
    stopTimer();
    PendoFlutterPlugin.track('Getting_ready_a_spanish',
