...
import '../widgets/postop_portals_widget_spanish.dart';
import 'package:pendo_sdk/pendo_sdk.dart';

class AfterSurgeryPageBSpanish extends StatefulWidget {
  const AfterSurgeryPageBSpanish({Key? key}) : super(key: key);

  @override
  State<AfterSurgeryPageBSpanish> createState() =>
      _AfterSurgeryPageStateBSpanish();
}

class _AfterSurgeryPageStateBSpanish extends State<AfterSurgeryPageBSpanish>
                          ...
                          Padding(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () {
                                submitSeconds("Finished");
                                Navigator.pushNamed(
                                    context, '/healing_at_home_spanish');
                              },
                              child: Padding(
  ...
  void submitSeconds(String state) {
    stopTimer();
    PendoFlutterPlugin.track('After_surgery_b_spanish',
