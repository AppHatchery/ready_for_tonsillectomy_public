...
class StretcherSM extends StatefulWidget {
  const StretcherSM({Key? key}) : super(key: key);

  @override
  _StretcherSMState createState() => _StretcherSMState();
}

class _StretcherSMState extends State<StretcherSM> {
  SMITrigger? _blue;
  SMITrigger? _green;
  SMITrigger? _orange;
  SMITrigger? _red;
  ...
  Widget build(BuildContext context) {
    return Column(mainAxisSize: MainAxisSize.min, children: [
      ...
      SizedBox(
          ...
          width: screenWidth,
          child: RiveAnimation.asset('assets/pacu/stretcher_sm.riv',
