...
import '../widgets/operating_room_widget.dart';
import '../widgets/surgical_tray_widget.dart';
import '../widgets/tour_text_widget.dart';
import '../widgets/or_next_panel.dart';
import 'package:pendo_sdk/pendo_sdk.dart';

class OperatingRoomPage extends StatefulWidget {
  const OperatingRoomPage({Key? key}) : super(key: key);

  @override
  State<OperatingRoomPage> createState() => _OperatingRoomPageState();
}

class _OperatingRoomPageState extends State<OperatingRoomPage>
            ...
            child: Column(children: [
              ...
              GestureDetector(
                  child: Stack(alignment: Alignment.center, children: [
                    ...
                    const MenuTileWidget(position: "5", title: "the OR"),
                  ]),
                  onTap: () {
                    submitSeconds("Finished");
                        ...
                        RichText(
                          text: TextSpan(
                              ...
                              children: const <TextSpan>[
                                ...
                                TextSpan(
                                    text:
                                        ". \nAsk if you can bring a buddy, \nlike a toy or parent."),
                              ]),
                        ),
                        const TourText(),
                      ]),
                ),
                const OperatingRoomSM(),
                const TrayOverlay(),
              ]),
            ]),
          ),
  ...
  void submitSeconds(String state) {
    ...
    PendoFlutterPlugin.track(
        'Operating_room', {'time_on_page': secondsSpent, 'status': state});
  }
}
