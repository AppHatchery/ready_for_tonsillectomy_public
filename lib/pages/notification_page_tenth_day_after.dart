...
class NotificationPageTenthDayAfter extends StatefulWidget {
  const NotificationPageTenthDayAfter({Key? key}) : super(key: key);

  @override
  State<NotificationPageTenthDayAfter> createState() =>
      _NotificationPageTenthDayAfterState();
}

class _NotificationPageTenthDayAfterState
    extends State<NotificationPageTenthDayAfter> with WidgetsBindingObserver {
  //For Pendo
  late Timer timer;
  int secondsSpent = 0;
  @override
        ...
        child: SingleChildScrollView(
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Padding(
              ...
              child: Text(
                "Many kids are starting to feel better by this point, but don’t worry if your child still has pain. "
  ...
  void submitSeconds(String state) {
    stopTimer();
    PendoFlutterPlugin.track('NotificationPageTenthDayAfter',
