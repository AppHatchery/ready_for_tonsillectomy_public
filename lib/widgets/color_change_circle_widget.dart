...
class ColorChangeCircle extends StatefulWidget {
  const ColorChangeCircle({Key? key}) : super(key: key);

  @override
  State<ColorChangeCircle> createState() => _ColorChangeCircleState();
}

class _ColorChangeCircleState extends State<ColorChangeCircle>
        ...
        Padding(
          ...
          child: Stack(alignment: Alignment.center, children: [
            ...
            SizedBox(
                ...
                child: SvgPicture.asset('assets/sleep/bubblegum.svg')),
          ]),
        ),
        Padding(
