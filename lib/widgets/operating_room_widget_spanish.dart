...
class OperatingRoomSMSpanish extends StatefulWidget {
  const OperatingRoomSMSpanish({Key? key}) : super(key: key);

  @override
  _OperatingRoomSMSpanishState createState() => _OperatingRoomSMSpanishState();
}

class _OperatingRoomSMSpanishState extends State<OperatingRoomSMSpanish> {
  SMITrigger? _bed;
  SMITrigger? _nurse;
    ...
    return Stack(children: [
      SizedBox(
          ...
          child: RiveAnimation.asset(
              'assets/operating_room/operating_room_sm_spanish.riv',
