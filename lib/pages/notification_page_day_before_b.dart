...
class NotificationPageDayBeforeB extends StatefulWidget {
  const NotificationPageDayBeforeB({Key? key}) : super(key: key);

  @override
  State<NotificationPageDayBeforeB> createState() =>
      _NotificationPageDayBeforeBState();
}

class _NotificationPageDayBeforeBState extends State<NotificationPageDayBeforeB>
        ...
        child: SingleChildScrollView(
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Padding(
              ...
              child: Text(
                "Your child might be feeling nervous about surgery. "
                "Today is a good day to go through the app again and ask your child if they have questions. "
                "Let them know that feeling a little nervous is normal. Your care team will be there to help! \n\n"
                "Remember to check your doctor’s instructions about when your child should stop eating and drinking before surgery.",
                style: TextStyle(
                    letterSpacing: 0,
                    height: 1.2,
                    fontFamily: "proxima",
  ...
  void submitSeconds(String state) {
    stopTimer();
    PendoFlutterPlugin.track('NotificationPageDayBeforeB',
