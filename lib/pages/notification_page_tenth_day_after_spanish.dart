...
class NotificationPageTenthDayAfterSpanish extends StatefulWidget {
  const NotificationPageTenthDayAfterSpanish({Key? key}) : super(key: key);

  @override
  State<NotificationPageTenthDayAfterSpanish> createState() =>
      _NotificationPageTenthDayAfterSpanishState();
}

class _NotificationPageTenthDayAfterSpanishState
    extends State<NotificationPageTenthDayAfterSpanish>
        ...
        child: SingleChildScrollView(
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Padding(
              ...
              child: Text(
                "Para este momento hay muchos niños que ya se han empezado a sentir mejor, pero si su hijo todavía tiene dolor, no se preocupe. "
            ...
            SizedBox(
                ...
                child: SvgPicture.asset('assets/notifications/kids.svg')),
  ...
  void submitSeconds(String state) {
    stopTimer();
    PendoFlutterPlugin.track('NotificationPageTenthDayAfterSpanish',
