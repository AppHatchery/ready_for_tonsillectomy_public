...
import '../widgets/hospital_gown_widget.dart';
import '../widgets/hospital_next_button_widget_b.dart';
import 'package:pendo_sdk/pendo_sdk.dart';

class GettingReadyPageC extends StatefulWidget {
  const GettingReadyPageC({Key? key}) : super(key: key);

  @override
  State<GettingReadyPageC> createState() => _GettingReadyPageStateC();
}

class _GettingReadyPageStateC extends State<GettingReadyPageC>
              ...
              Column(children: [
                Padding(
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        text:
                            "Next, you put on special pajamas for surgery. \nIt’s called a ",
                        style: TextStyle(
                            letterSpacing: 0,
                            height: 1.2,
                            fontFamily: "proxima",
                        ...
                        children: const <TextSpan>[
                          ...
                          TextSpan(
                              text:
                                  ". You wear a \nbracelet with your name on it, too.")
                        ]),
                  ),
                ),
                Container(
  ...
  void submitSeconds(String state) {
    ...
    PendoFlutterPlugin.track(
        'Getting_ready_c', {'time_on_page': secondsSpent, 'status': state});
  }
}
