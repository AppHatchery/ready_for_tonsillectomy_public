...
class NotificationPageDayAfterSpanish extends StatefulWidget {
  const NotificationPageDayAfterSpanish({Key? key}) : super(key: key);

  @override
  State<NotificationPageDayAfterSpanish> createState() =>
      _NotificationPageDayAfterSpanishState();
}

class _NotificationPageDayAfterSpanishState
    extends State<NotificationPageDayAfterSpanish> with WidgetsBindingObserver {
  //For Pendo
  late Timer timer;
  int secondsSpent = 0;
  @override
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Padding(
              ...
              child: RichText(
                text: TextSpan(
                    text:
                        "La recuperación de la cirugía exige esfuerzo. En los días siguientes a la cirugía es posible que su hijo duerma más de lo acostumbrado. \n\nTenga bastantes ",
                    style: TextStyle(
                        letterSpacing: 0,
                        height: 1.2,
                        fontFamily: "proxima",
                    ...
                    children: const <TextSpan>[
                      ...
                      TextSpan(
                          text:
                              " a su alcance para cuando esté despierto. Para no olvidar los horarios de la medicina para el dolor se recomienda "),
                      TextSpan(
                          text: "hacer un cartel",
                          style: TextStyle(
                              letterSpacing: 0,
                              height: 1.2,
                              fontWeight: FontWeight.bold)),
                      TextSpan(text: " con las horas."),
                    ]),
              ),
            ),
            SizedBox(
                ...
                child:
                    SvgPicture.asset('assets/notifications/chart_spanish.svg')),
  ...
  void submitSeconds(String state) {
    stopTimer();
    PendoFlutterPlugin.track('NotificationPageDayAfterSpanish',
