...
import '../widgets/hospital_text_widget_spanish.dart';
import '../widgets/hospital_next_button_widget_a_spanish.dart';
import 'package:pendo_sdk/pendo_sdk.dart';

class GettingReadyPageBSpanish extends StatefulWidget {
  const GettingReadyPageBSpanish({Key? key}) : super(key: key);

  @override
  State<GettingReadyPageBSpanish> createState() =>
      _GettingReadyPageStateBSpanish();
}

class _GettingReadyPageStateBSpanish extends State<GettingReadyPageBSpanish>
  ...
  Widget build(BuildContext context) {
    _size = MediaQuery.of(context).size;
    return Scaffold(
      backgroundColor: HexColor("#fdfbdf"),
        ...
        child: SingleChildScrollView(
          child: Stack(alignment: Alignment.topCenter, children: [
            Stack(alignment: Alignment.bottomCenter, children: [
              Container(height: 0.3 * screenWidth, color: HexColor("#e5e6e7")),
              HospitalNextButton1Spanish(
            ...
            Padding(
              ...
              child: SizedBox(
                  width: screenWidth,
                  height: 1.2125 * screenWidth,
                  child: const RiveAnimation.asset(
                      'assets/getting_ready/scale.riv')),
            ),
            const HospitalTextSpanish(),
          ]),
        ),
      ),
    );
  ...
  void submitSeconds(String state) {
    stopTimer();
    PendoFlutterPlugin.track('Getting_ready_b_spanish',
