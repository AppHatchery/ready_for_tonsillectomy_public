...
class NotificationPageDayBeforeA extends StatefulWidget {
  const NotificationPageDayBeforeA({Key? key}) : super(key: key);

  @override
  State<NotificationPageDayBeforeA> createState() =>
      _NotificationPageDayBeforeAState();
}

class _NotificationPageDayBeforeAState extends State<NotificationPageDayBeforeA>
...
//For Pendo
        ...
        child: SingleChildScrollView(
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Padding(
              ...
              child: Text(
                "Surgery is tomorrow! Kids can often sense when their parents are worried. "
  ...
  void submitSeconds(String state) {
    stopTimer();
    PendoFlutterPlugin.track('NotificationPageDayBeforeA',
