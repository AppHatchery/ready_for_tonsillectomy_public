...
import '../widgets/big_tonsils_widget_spanish.dart';
import '../widgets/apnea_widget_spanish.dart';
import 'package:pendo_sdk/pendo_sdk.dart';

class WhySurgeryPageBSpanish extends StatefulWidget {
  const WhySurgeryPageBSpanish({Key? key}) : super(key: key);

  @override
  State<WhySurgeryPageBSpanish> createState() => _WhySurgeryPageStateBSpanish();
}

class _WhySurgeryPageStateBSpanish extends State<WhySurgeryPageBSpanish>
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          Align(
            ...
            child: Padding(
              ...
              child: Text(
                  "Algunos niños tienen las amígdalas muy \ngrandes. En lugar de estar escondidas a los lados \nde la garganta casi que se ¡tocan en el centro!",
          ...
          const BigTonsilsAnimationSpanish(),
          Padding(
              padding: EdgeInsets.only(
                  top: 0.0267 * screenWidth, bottom: 0.0533 * screenWidth),
              child: const ApneaSliderSpanish()),
          Padding(
  ...
  void submitSeconds(String state) {
    stopTimer();
    PendoFlutterPlugin.track('Why_surgery_b_spanish',
