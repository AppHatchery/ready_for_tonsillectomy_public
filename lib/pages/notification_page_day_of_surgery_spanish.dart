...
class NotificationPageDOSSpanish extends StatefulWidget {
  const NotificationPageDOSSpanish({Key? key}) : super(key: key);

  @override
  State<NotificationPageDOSSpanish> createState() =>
      _NotificationPageDOSSpanishState();
}

class _NotificationPageDOSSpanishState extends State<NotificationPageDOSSpanish>
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Padding(
              ...
              child: RichText(
                text: TextSpan(
                    text:
                        "¡Llegó el gran día! Por la seguridad de su hijo, en la mañana de la cirugía el estómago debe estar vacío. ",
                    style: TextStyle(
                        letterSpacing: 0,
                        height: 1.2,
                        fontFamily: "proxima",
                    ...
                    children: const <TextSpan>[
                      ...
                      TextSpan(
                          text:
                              ". \n\nAntes de la cirugía, la mayoría de los niños toman algo transparente: agua, jugo de manzana o refresco para deportistas. Sin embargo, siempre deben "),
                      TextSpan(
                          text: "seguir las instrucciones",
                          style: TextStyle(
                              letterSpacing: 0,
                              height: 1.2,
                              fontWeight: FontWeight.bold)),
                      TextSpan(
                          text:
                              " acerca de la hora en que debe dejar de tomar líquidos."),
                    ]),
              ),
            ),
            SizedBox(
                ...
                child: SvgPicture.asset('assets/notifications/no_food.svg')),
  ...
  void submitSeconds(String state) {
    stopTimer();
    PendoFlutterPlugin.track('NotificationPageDOSSpanish',
