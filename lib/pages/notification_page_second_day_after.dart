...
class NotificationPageSecondDayAfter extends StatefulWidget {
  const NotificationPageSecondDayAfter({Key? key}) : super(key: key);

  @override
  State<NotificationPageSecondDayAfter> createState() =>
      _NotificationPageSecondDayAfterState();
}

class _NotificationPageSecondDayAfterState
    extends State<NotificationPageSecondDayAfter> with WidgetsBindingObserver {
  //For Pendo
  late Timer timer;
  int secondsSpent = 0;
  @override
        ...
        child: SingleChildScrollView(
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Padding(
              ...
              child: Text(
                "Your child might have a fever in the first 2-3 days after surgery. "
                "Most kids who have a fever right after surgery are not sick—just trying to get better! "
                "\n\nIf your child’s temperature doesn’t come down after using acetaminophen or ibuprofen, check in with your doctor.",
                style: TextStyle(
                    letterSpacing: 0,
                    height: 1.2,
                    fontFamily: "proxima",
            ...
            SizedBox(
                ...
                child:
                    SvgPicture.asset('assets/notifications/thermometer.svg')),
  ...
  void submitSeconds(String state) {
    stopTimer();
    PendoFlutterPlugin.track('NotificationPageSecondDayAfter',
