...
import '../widgets/stretcher_widget.dart';
import '../widgets/pacu_next_button_widget.dart';
import 'package:pendo_sdk/pendo_sdk.dart';

class AfterSurgeryPageA extends StatefulWidget {
  const AfterSurgeryPageA({Key? key}) : super(key: key);

  @override
  State<AfterSurgeryPageA> createState() => _AfterSurgeryPageStateA();
}

class _AfterSurgeryPageStateA extends State<AfterSurgeryPageA>
  ...
  void submitSeconds(String state) {
    ...
    PendoFlutterPlugin.track(
        'After_surgery_a', {'time_on_page': secondsSpent, 'status': state});
  }
}
