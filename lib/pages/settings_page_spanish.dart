...
class SettingsPageSpanish extends StatefulWidget {
  const SettingsPageSpanish({Key? key}) : super(key: key);

  @override
  State<SettingsPageSpanish> createState() => _SettingsPageSpanishState();
}

class _SettingsPageSpanishState extends State<SettingsPageSpanish>
        ...
        child: Column(children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: () => showDialog<String>(
                ...
                builder: (BuildContext context) => AlertDialog(
                  ...
                  content: SizedBox(
                    ...
                    width: 300.0,
                    child: Text(
                        "¡Por favor evalua nuestra aplicación en el App Store!",
                        style: TextStyle(
                            letterSpacing: 0,
                            height: 1.2,
                            color: HexColor("#214b68"),
              ...
              child: Row(children: [
                Padding(
                    padding: EdgeInsets.only(top: 0.012 * screenWidth),
                    child: Text("¡CALIFÍCA ESTA APLICACIÓN!",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            letterSpacing: 0,
                            height: 1.2,
          ...
          Padding(
            ...
            child:
              ...
              RichText(
                ...
                text: TextSpan(
                    ...
                    children: const <TextSpan>[
                      ...
                      TextSpan(
                          text:
                              " fue diseñado y desarrollado por Holly Cordray con el apoyo de la Dra. Kara Prickett, del Departamento de Otorrinolaringología, cirugía de cabeza y cuello, de la Escuela de Medicina de la Universidad de Emory, y del AppHatchery de la Alianza de Georgia para las ciencias clínicas y de traslación."),
                    ]),
              ),
              SizedBox(height: 0.0587 * screenWidth),
              Text(
                  "Esta aplicación se benefició de la retroalimentación de pacientes y padres que participaron en una investigación en Children’s Healthcare of Atlanta.",
                  style: TextStyle(
                      letterSpacing: 0,
                      height: 1.2,
                      fontFamily: "proxima",
              ...
              SizedBox(height: 0.0587 * screenWidth),
              Text(
                  "Su contenido está basado en conocimientos clínicos y en las fuentes de información (abajo están los enlaces) sobre las prácticas idóneas en una amigdalectomía:",
                  style: TextStyle(
                      letterSpacing: 0,
                      height: 1.2,
                      fontFamily: "proxima",
              ...
              Text(
                  "Copyright © 2023 Emory University y Holly Cordray. Todos los derechos reservados.",
                  style: TextStyle(
                      letterSpacing: 0,
                      height: 1.2,
                      fontFamily: "proxima",
  ...
  void submitSeconds(String state) {
    ...
    PendoFlutterPlugin.track(
        'Settings_spanish', {'time_on_page': secondsSpent, 'status': state});
  }
}
