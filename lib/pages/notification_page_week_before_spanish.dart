...
class NotificationPageWeekBeforeSpanish extends StatefulWidget {
  const NotificationPageWeekBeforeSpanish({Key? key}) : super(key: key);

  @override
  State<NotificationPageWeekBeforeSpanish> createState() =>
      _NotificationPageWeekBeforeSpanishState();
}

class _NotificationPageWeekBeforeSpanishState
    extends State<NotificationPageWeekBeforeSpanish>
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Padding(
              ...
              child: RichText(
                text: TextSpan(
                    text:
                        "La ansiedad que una cirugía causa en los niños se puede disminuir cuando ellos saben que pueden esperar. Hable con su hijo acerca de la cirugía y de lo que va a pasar ese día. Repasen juntos la aplicación ",
                    style: TextStyle(
                        letterSpacing: 0,
                        height: 1.2,
                        fontFamily: "proxima",
  ...
  void submitSeconds(String state) {
    stopTimer();
    PendoFlutterPlugin.track('NotificationPageWeekBeforeSpanish',
