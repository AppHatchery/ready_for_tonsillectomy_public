...
class SleepNextButton extends StatefulWidget {
  final Function()? callback;
  const SleepNextButton({Key? key, this.callback}) : super(key: key);

  @override
  State<SleepNextButton> createState() => _SleepNextButtonState();
}

class _SleepNextButtonState extends State<SleepNextButton>
      ...
      child: Padding(
        ...
        child: ElevatedButton(
          ...
          onPressed: () {
            ...
            Navigator.pushNamed(context, '/going_to_sleep_b');
          },
          child: Padding(
