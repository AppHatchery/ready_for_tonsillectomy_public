...
class NotificationPageDayBeforeBSpanish extends StatefulWidget {
  const NotificationPageDayBeforeBSpanish({Key? key}) : super(key: key);

  @override
  State<NotificationPageDayBeforeBSpanish> createState() =>
      _NotificationPageDayBeforeBSpanishState();
}

class _NotificationPageDayBeforeBSpanishState
    extends State<NotificationPageDayBeforeBSpanish>
        ...
        child: SingleChildScrollView(
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Padding(
              ...
              child: Text(
                "La cirugía puede hacer que su hijo esté nervioso. "
  ...
  void submitSeconds(String state) {
    stopTimer();
    PendoFlutterPlugin.track('NotificationPageDayBeforeBSpanish',
