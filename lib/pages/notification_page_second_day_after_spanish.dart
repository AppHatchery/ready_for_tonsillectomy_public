...
class NotificationPageSecondDayAfterSpanish extends StatefulWidget {
  const NotificationPageSecondDayAfterSpanish({Key? key}) : super(key: key);

  @override
  State<NotificationPageSecondDayAfterSpanish> createState() =>
      _NotificationPageSecondDayAfterSpanishState();
}

class _NotificationPageSecondDayAfterSpanishState
    extends State<NotificationPageSecondDayAfterSpanish>
        ...
        child: SingleChildScrollView(
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Padding(
              ...
              child: Text(
                "Su hijo puede presentar fiebre 2 o 3 días después de la cirugía. "
  ...
  void submitSeconds(String state) {
    stopTimer();
    PendoFlutterPlugin.track('NotificationPageSecondDayAfterSpanish',
