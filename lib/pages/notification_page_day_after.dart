...
class NotificationPageDayAfter extends StatefulWidget {
  const NotificationPageDayAfter({Key? key}) : super(key: key);

  @override
  State<NotificationPageDayAfter> createState() =>
      _NotificationPageDayAfterState();
}

class _NotificationPageDayAfterState extends State<NotificationPageDayAfter>
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Padding(
              ...
              child: RichText(
                text: TextSpan(
                    text:
                        "Recovering from surgery is hard work. Your child may sleep more than normal in the few days following surgery. \n\nKeep plenty of ",
                    style: TextStyle(
                        letterSpacing: 0,
                        height: 1.2,
                        fontFamily: "proxima",
                    ...
                    children: const <TextSpan>[
                      ...
                      TextSpan(
                          text:
                              " around when your child is awake. Think about "),
                      TextSpan(
                          text: "making a chart",
                          style: TextStyle(
                              letterSpacing: 0,
                      ...
                      TextSpan(
                          text:
                              " to help you stay on top of the pain medicine schedule."),
                    ]),
              ),
            ),
            SizedBox(
                ...
                child: SvgPicture.asset('assets/notifications/chart.svg')),
  ...
  void submitSeconds(String state) {
    stopTimer();
    PendoFlutterPlugin.track('NotificationPageDayAfter',
